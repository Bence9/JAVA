...
public class Login extends JFrame{
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 586, 397);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				while((line=br.readLine())!=null) {
					if(line.equals(felhasznalonev + "\t" + jelszo)) {
						matched=true;
						break;
					}
				}
				fr.close();
					...
					SM("Hiba a belépés közben "+ie.getMessage());
				}
		...
		btnNewButton.setBounds(322, 241, 130, 39);
		...
		btnTrl.setBounds(123, 305, 130, 39);
		...
		btnKilp.setBounds(322, 305, 130, 39);
		...
		JButton btnRegi = new JButton("Regisztráció");
		...
		btnRegi.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnRegi.setBounds(123, 241, 130, 39);
